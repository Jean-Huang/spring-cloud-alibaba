 ...
 * @author Cursor
 */
public class NoopRuleRuntimePlatformClient implements RuleRuntimePlatformClient {

	@Override
	public RulePublishResult publish(CompiledRuleSet compiledRuleSet) {
		return RulePublishResult.skipped(compiledRuleSet.getId(),
				compiledRuleSet.getVersion(),
				"No rule runtime platform client configured");
	}
